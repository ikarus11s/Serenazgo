import threading
import time
from scripts.simulation_automovil import simulate_automovil
from scripts.simulation_a_pie import simulate_a_pie
from scripts.simulation_motorizado import simulate_motorizado
